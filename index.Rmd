...
```{r}
data <- pew |>
  select(q4, q7q8_combo, q11a, q11b)
data
```
q4 -- if individual is native born or not
q7q8 combo -- parents nativity
q11a -- maternal grandparents nativity
q11b -- paternal grandparents nativity

*** just look at degree of ancestry --- dw abt maternal/paternal bs 
